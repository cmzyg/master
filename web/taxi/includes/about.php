    ...
    <div class="pre-content-overlay"></div>
          ...
          <div id="content-wrap" class="row">
            <div id="content" class="seven columns">
              <div class="region region-content" style="margin-left: 5px;">
            ...
            <div id="content" class="five columns" style="padding-left: 25px; padding-top: 25px; margin-left: 20px; margin-top: 20px;">
              <div class="region region-content">

                <p><img style="width:90%; float: right" src="<?php echo $other_pages['about_us_image']; ?>" /></p>
