...
$seo['meta_keywords_title'] == '' ? $seo['meta_title_other'] = 'Terms' : $seo['meta_title_other'] = $seo['meta_title_other'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<?php include('includes/header.php'); ?>
    ...
    <div id="content" class="eighteen columns">
              <div class="region region-content">
                  ...
                  <h2 class='lead'><strong>Terms & Conditions</strong></h2>
                  <?php echo nl2br($value['terms_text']); ?>
