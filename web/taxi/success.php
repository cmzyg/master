...
<title>Booking Successful | <?php echo $seo['meta_title_other']; ?></title>
...
<?php include('includes/header.php'); ?>
    ...
    <div class="row"> 
        ...
        <div class="breadcrumb"> <span class="crumbs"><a href="<?php echo $base_url; ?>">Home</a></span> <span class="crumbs-current">>
          Book </span> </div>
              ...
              <!-- end breadcrumb -->
              <div class="page-title">Booking Successful</div>
            </div>
    ...
    <div id="content" class="eighteen columns">
              <div class="region region-content">
                  ...
                  <h4 class='lead'><strong><?php echo $success_title; ?></strong></h4>

                  <p>Thank you for your booking.</p>
                  <p>An email has been sent, please check your inbox/ junk or spam folder.</p>
                  <p>You will receive confirmation via email, as soon as your booking has been processed.</p>
