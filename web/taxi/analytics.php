...
<tr valign="top">
	...
	<td><input style='width:60px; text-align: center;' type="text" id="blogname" value="<?php echo $ga->getVisits(); ?>" class="regular-text" /></td>
</tr>

<tr valign="top">
	<th scope="row"><label for="blogname">Pageviews</label></th>
	<td><input style='width:60px; text-align: center;' type="text" id="blogname" value="<?php echo $ga->getPageviews(); ?>" class="regular-text" /></td>
</tr>
