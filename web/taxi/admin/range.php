...
{
	$bookings_list = $bookings->getBookingsByRange($_SESSION['date_from'], $_SESSION['date_to']);
}
...
<!--[if lte IE 7]>
<link rel='stylesheet' id='ie-css'  href='http://www.classy-design.co.uk/taxi/admin/assets/css/ie.min.css' type='text/css' media='all' />
<![endif]-->
...
<link rel="stylesheet" href="../../assets/css/datepicker/styles.css" />
<link rel="stylesheet" href="../../assets/css/datepicker/jquery.ui.all.css">
...
<table class="wp-list-table widefat fixed users" cellspacing="0">
	...
	<?php
       ...
       if (count($bookings_array)) {
          ...
          $pagination = new pagination($bookings_array, (isset($_GET['page']) ? $_GET['page'] : 1), 10, 'range');
