...
$count_bookings = $bookings->countBookingsByDate(date('Y-m-d'));

$count = 0;
$bookings_array = array();

$bookings_list = $bookings->getTodaysBookings();
...
foreach($bookings_list as $rows)
{
	...
	$bookings_array[$count]['airport_name']  = $rows['airport_name'];
	$bookings_array[$count]['terminal']      = $rows['terminal'];
	$bookings_array[$count]['flight_number'] = $rows['flight_number'];
    $count++;
}
...
<table class="wp-list-table widefat fixed users" cellspacing="0">
	...
	<tr id='user-1' class="alternate">
		...
		<td class='<?php echo $row['status']; ?>'><strong>From:</strong> <?php echo $row['from']; ?><br /> <strong>To:</strong> <?php echo $row['to']; ?><br /><strong>Pickup:</strong> <?php echo $row['actual_pickup']; ?></td>
	...
	<tr class="alternate" class="more_info_2" style="display:none">
		...
		<td><strong>Airport</strong> <br /><?php echo $row['airport_name']; ?></td>
		<td><strong>Terminal</strong> <br /><?php echo $row['terminal']; ?></td>
	</tr>
