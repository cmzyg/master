...
<form method="post" action="<?php echo $admin_url; ?>process-fixed-prices" enctype="multipart/form-data">
...
<td><input name="free_text_1" type="text" id="blogname" style="text-align: center;" value="<?php echo $value['free_text_1']; ?>" class="regular-text" /></td>
</tr>
...
<tr valign="top">
<th scope="row"><label for="blogname">Free Text</label></th>
<td><input name="free_text_2" type="text" id="blogname" style="text-align: center;" value="<?php echo $value['free_text_2']; ?>" class="regular-text" /></td>
</tr>
...
<tr valign="top">
<th scope="row"><label for="blogname">Destination 3</label></th>
<td>
...
<tr valign="top">
<th scope="row"><label for="blogname">Destination 3 Image</label></th>
<td style="float:left"><img src="../../<?php echo $value['fixed_price_3_img']; ?>" width="200" height="100" /></td>
<td style="float:left"><input name="file3" type="file" id="blogname" value="" class="regular-text" /></td>
</tr>

<tr valign="top">
<th scope="row"><label for="blogname">Free Text</label></th>
<td><input name="free_text_3" type="text" id="blogname" style="text-align: center;" value="<?php echo $value['free_text_3']; ?>" class="regular-text" /></td>
</tr>
...
<tr valign="top">
<th scope="row"><label for="blogname">Destination 4</label></th>
...
<tr valign="top">
<th scope="row"><label for="blogname">Destination 4 Image</label></th>
<td style="float:left"><img src="../../<?php echo $value['fixed_price_4_img']; ?>" width="200" height="100" /></td>
<td style="float:left"><input name="file4" type="file" id="blogname" value="" class="regular-text" /></td>
</tr>

<tr valign="top">
<th scope="row"><label for="blogname">Free Text</label></th>
<td><input name="free_text_4" type="text" id="blogname" style="text-align: center;" value="<?php echo $value['free_text_4']; ?>" class="regular-text" /></td>
</tr>
...
<tr valign="top">
<th scope="row"><label for="blogname">Destination 5</label></th>
...
<tr valign="top">
<th scope="row"><label for="blogname">Destination 5 Image</label></th>
<td style="float:left"><img src="../../<?php echo $value['fixed_price_5_img']; ?>" width="200" height="100" /></td>
<td style="float:left"><input name="file5" type="file" id="blogname" value="" class="regular-text" /></td>
</tr>

<tr valign="top">
<th scope="row"><label for="blogname">Free Text</label></th>
<td><input name="free_text_5" type="text" id="blogname" style="text-align: center;" value="<?php echo $value['free_text_5']; ?>" class="regular-text" /></td>
</tr>
...
<tr valign="top">
<th scope="row"><label for="blogname">Destination 6</label></th>
...
<tr valign="top">
<th scope="row"><label for="blogname">Destination 6 Image</label></th>
<td style="float:left"><img src="../../<?php echo $value['fixed_price_6_img']; ?>" width="200" height="100" /></td>
<td style="float:left"><input name="file6" type="file" id="blogname" value="" class="regular-text" /></td>
</tr>

<tr valign="top">
<th scope="row"><label for="blogname">Free Text</label></th>
<td><input name="free_text_6" type="text" id="blogname" style="text-align: center;" value="<?php echo $value['free_text_6']; ?>" class="regular-text" /></td>
</tr>
...
<tr valign="top">
<th scope="row"><label for="blogname">Destination 7</label></th>
<td>
...
<tr valign="top">
<th scope="row"><label for="blogname">Destination 7 Image</label></th>
<td style="float:left"><img src="../../<?php echo $value['fixed_price_7_img']; ?>" width="200" height="100" /></td>
<td style="float:left"><input name="file7" type="file" id="blogname" value="" class="regular-text" /></td>
</tr>

<tr valign="top">
<th scope="row"><label for="blogname">Free Text</label></th>
<td><input name="free_text_7" type="text" id="blogname" style="text-align: center;" value="<?php echo $value['free_text_7']; ?>" class="regular-text" /></td>
</tr>
...
<tr valign="top">
<th scope="row"><label for="blogname">Destination 8</label></th>
<td>
...
<tr valign="top">
<th scope="row"><label for="blogname">Destination 8 Image</label></th>
<td style="float:left"><img src="../../<?php echo $value['fixed_price_8_img']; ?>" width="200" height="100" /></td>
<td style="float:left"><input name="file8" type="file" id="blogname" value="" class="regular-text" /></td>
</tr>

<tr valign="top">
<th scope="row"><label for="blogname">Free Text</label></th>
<td><input name="free_text_8" type="text" id="blogname" style="text-align: center;" value="<?php echo $value['free_text_8']; ?>" class="regular-text" /></td>
</tr>
...
<tr valign="top">
<th scope="row"><label for="blogname">Destination 9</label></th>
<td>
...
<tr valign="top">
<th scope="row"><label for="blogname">Destination 9 Image</label></th>
<td style="float:left"><img src="../../<?php echo $value['fixed_price_9_img']; ?>" width="200" height="100" /></td>
<td style="float:left"><input name="file9" type="file" id="blogname" value="" class="regular-text" /></td>
</tr>

<tr valign="top">
<th scope="row"><label for="blogname">Free Text</label></th>
<td><input name="free_text_9" type="text" id="blogname" style="text-align: center;" value="<?php echo $value['free_text_9']; ?>" class="regular-text" /></td>
</tr>
...
<tr valign="top">
<th scope="row"><label for="blogname">Destination 10</label></th>
<td>
...
<tr valign="top">
<th scope="row"><label for="blogname">Destination 10 Image</label></th>
<td style="float:left"><img src="../../<?php echo $value['fixed_price_10_img']; ?>" width="200" height="100" /></td>
<td style="float:left"><input name="file10" type="file" id="blogname" value="" class="regular-text" /></td>
</tr>

<tr valign="top">
<th scope="row"><label for="blogname">Free Text</label></th>
<td><input name="free_text_10" type="text" id="blogname" style="text-align: center;" value="<?php echo $value['free_text_10']; ?>" class="regular-text" /></td>
</tr>
...
<tr valign="top">
<th scope="row"><label for="blogname">Destination 11</label></th>
<td>
...
<tr valign="top">
<th scope="row"><label for="blogname">Destination 11 Image</label></th>
<td style="float:left"><img src="../../<?php echo $value['fixed_price_11_img']; ?>" width="200" height="100" /></td>
<td style="float:left"><input name="file11" type="file" id="blogname" value="" class="regular-text" /></td>
</tr>

<tr valign="top">
<th scope="row"><label for="blogname">Free Text</label></th>
<td><input name="free_text_11" type="text" id="blogname" style="text-align: center;" value="<?php echo $value['free_text_11']; ?>" class="regular-text" /></td>
</tr>
...
<tr valign="top">
<th scope="row"><label for="blogname">Destination 12</label></th>
<td>
...
<tr valign="top">
<th scope="row"><label for="blogname">Destination 12 Image</label></th>
<td style="float:left"><img src="../../<?php echo $value['fixed_price_12_img']; ?>" width="200" height="100" /></td>
<td style="float:left"><input name="file12" type="file" id="blogname" value="" class="regular-text" /></td>
</tr>

<tr valign="top">
<th scope="row"><label for="blogname">Free Text</label></th>
<td><input name="free_text_12" type="text" id="blogname" style="text-align: center;" value="<?php echo $value['free_text_12']; ?>" class="regular-text" /></td>
</tr>
